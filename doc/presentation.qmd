...
Tumor Break Load and hypoxia together mark aggressive tumors with poorer survival.
...
- Mixed groups outperform low/low, suggesting single adverse factors partially mitigate harm.
...
Low oxygen levels in tumors (hypoxia) are associated with resistance to radiation therapy.
...
- Ragnum : ↓ hypoxia → clear survival advantage
- Other: no difference
:::
