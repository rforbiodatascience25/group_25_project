...
<div style="text-align:center;">
  <img src="04description1.png"
       style="width:36%; max-width:none;">
</div>

- Figure created with BioRender [@BioRender].
...
MSI_heatmap <- ggplot(df_msi,
  ...
  theme_uniform() +
  theme(
    legend.position = "bottom",              # move z-score bar below
    legend.title = element_text(size = 10),
    legend.key.width = unit(2, "lines"),
    axis.text.x = element_blank(),
    axis.ticks.x = element_blank()
  ) +
  guides(fill = guide_colourbar(title.position = "top")) +  # optional
  labs(
