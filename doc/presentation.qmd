...
![](04_describe_slide_1 (1).png){width=90%}
...
```{r}
#| echo: true          # show code on the slide
...
png("bubble_plot.png", width = 1080, height = 756, res = 96)
...
- Mixed groups ('high/low' or 'low/high') exhibit better survival than the 'low/low' group, suggesting that the presence of only one adverse factor may partially buffer the harmful impact.
