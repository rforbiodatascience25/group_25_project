...
{r}
data_metrics <- read_tsv(here("data_metrics_aug.tsv"))
data_gene <- read_tsv(here("data_gene_aug.tsv"))
data_score <- read_tsv(here("data_score_aug.tsv"))
data_code <- read_tsv(here("data_code_aug.tsv"))
data_diag <- read_tsv(here("data_diag_aug.tsv"))
...
Providing core statistics overview of the genetic mutation data with a basic descriptive stats table and histograms and boxplots. Outliers are removed to avoid making the graphs unreadable.
